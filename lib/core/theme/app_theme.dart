...
class AppTheme {
  ...
  ThemeData get light {
    ...
    final customText = _forceInherit(const TextTheme(
      displayLarge:
          TextStyle(fontSize: 48, color: _blackBG, fontWeight: FontWeight.w600),
      bodyLarge:
          TextStyle(fontSize: 20, color: _blackBG, fontWeight: FontWeight.w400),
      bodyMedium:
          TextStyle(fontSize: 16, color: _blackBG, fontWeight: FontWeight.w400),
      titleMedium:
          TextStyle(fontSize: 16, color: _blackBG, fontWeight: FontWeight.w400),
    ));

    return _applyCommonSanitization(
      theme.copyWith(
        ...
        colorScheme:
            ColorScheme.fromSwatch(primarySwatch: _mainAppColor).copyWith(
          primary: _primary,
          onPrimary: _white,
          surface: _white,
          onSurface: _blackBG,
        ...
        expansionTileTheme: const ExpansionTileThemeData(
          textColor: _primary,
          iconColor: _primary,
          collapsedIconColor: _blackBG,
          collapsedTextColor: _blackBG,
        ),
      ),
    );
  }
  ...
  ThemeData get dark {
    ...
    final customText = _forceInherit(const TextTheme(
      displayLarge:
          TextStyle(fontSize: 48, color: _white, fontWeight: FontWeight.w600),
      bodyLarge:
          TextStyle(fontSize: 20, color: _white, fontWeight: FontWeight.w400),
      bodyMedium:
          TextStyle(fontSize: 16, color: _white, fontWeight: FontWeight.w400),
      titleMedium:
          TextStyle(fontSize: 16, color: _white, fontWeight: FontWeight.w400),
    ));
  ...
  static TextTheme _forceInherit(TextTheme theme) {
    TextStyle fix(TextStyle? s) =>
        (s ?? const TextStyle()).copyWith(inherit: true);
    return TextTheme(
  ...
  ThemeData _applyCommonSanitization(ThemeData theme) {
    return theme.copyWith(
      ...
      inputDecorationTheme: theme.inputDecorationTheme.copyWith(
        labelStyle: (theme.inputDecorationTheme.labelStyle ?? const TextStyle())
            .copyWith(inherit: true),
        hintStyle: (theme.inputDecorationTheme.hintStyle ?? const TextStyle())
            .copyWith(inherit: true),
      ),
  ...
  CupertinoThemeData get lightCupertinoTheme => const CupertinoThemeData(
        ...
        textTheme: CupertinoTextThemeData(
            textStyle: TextStyle(inherit: true, fontSize: 16, color: _blackBG)),
      );

  CupertinoThemeData get darkCupertinoTheme => const CupertinoThemeData(
        brightness: Brightness.dark,
        textTheme: CupertinoTextThemeData(
            textStyle: TextStyle(inherit: true, fontSize: 16, color: _white)),
      );
}
